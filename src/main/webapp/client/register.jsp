      ...
      <form action="${pageContext.request.contextPath}/register" method="post" class="px-6 py-8 space-y-6">
        ...
        <div>
          ...
          <textarea name="address" id="address" required rows="2"
            ...
            class="h-20 w-full px-4 py-2 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none">${inputUser.address}</textarea>
        </div>
